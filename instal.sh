...
read SPARK_TOKEN
echo
echo "What is your Spark Room ID?"
read SPARK_ROOM
echo
...
#echo
#echo "http://ahod-$docker_username.$mantl_domain/hello/world"
#echo
#echo
