...
echo "Uninstalling the demoapp at ahod/$docker_username"
curl -k -X DELETE -u $mantl_user:$mantl_password https://$control_address:8080/v2/apps/imapex/ahod/iot-server-dev \
